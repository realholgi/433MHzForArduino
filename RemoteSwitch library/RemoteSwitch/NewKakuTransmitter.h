...
/**
* NewKakuTransmitter provides a generic class for simulation of common RF remote controls, like the A-series
...
*   or manufacturers may use other period length. Use the ShowReceivedCodeNewKaku example to find the
...
*/
class NewKakuTransmitter {
	public:
		/**
		* Constructor.
		*
		* To obtain the correct period length, use the ShowReceivedCodeNewKaku example, or you
		...
		*/
		NewKakuTransmitter(unsigned long address, unsigned short pin, unsigned int periodusec = 260, unsigned short repeats = 4);
